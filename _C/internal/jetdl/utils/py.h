#ifndef JETDL_UTILS_PY_H
#define JETDL_UTILS_PY_H

#include <pybind11/pybind11.h>

namespace py = pybind11;

template <typename T> inline bool python_utils_is_pylist(const T &data) {
  return py::isinstance<py::list>(data);
}

template <typename T> inline bool python_utils_is_num(const T &data) {
