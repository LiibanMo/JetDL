...
MatrixTransposeBackward::MatrixTransposeBackward(
    std::shared_ptr<Tensor>& a, std::shared_ptr<Tensor>& result_tensor) {
...
std::vector<std::shared_ptr<Tensor>> MatrixTransposeBackward::apply(
