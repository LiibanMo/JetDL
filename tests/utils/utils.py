...
class PyTestAsserts:
    ...
    def check_is_leaf(self) -> bool:
        return self.j.is_leaf == self.t.is_leaf
    ...
    def is_leaf_error_output(self) -> str:
        return f"Expected is_leaf to match: {self.j.is_leaf} vs {self.t.is_leaf}"
